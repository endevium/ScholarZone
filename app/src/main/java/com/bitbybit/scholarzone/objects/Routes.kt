...
object Routes {
    ...
    const val ScholarshipApplicationPage = "scholarshipApplicationPage/{id}/{application_name}/{company}/{application_description}/{application_image}/{duration}/{category}/{slots}/{deadline}"
    val ApplicationFormPage = "applicationFormPage/{scholarship_application_id}/{application_name}/{company}/{application_description}/{application_image}/{duration}/{category}/{slots}/{deadline}"
